...
export function SerpBlogShell({ title, description, actions, children }) {
        ...
        <header className="px-4 pt-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button as={Link} to="/serp-blog/competition" className="hidden rounded-full px-6 py-3 lg:inline-flex">
