...
export const login = async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            return res.json({
                success: false,
                message: "No user found belonging to this email id"
            })
        }
...
export const sendVerifyOtp = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            text: `Your OTP is ${otp} and this otp is only valid for 10 min`
        }
...
export const sendResetOtp = async (req, res) => {
    ...
    if (!email) {
        return res.json({
            success: false,
            message: "Email is required to reset otp please provide the email"
        })
    }
    ...
    try {
        ...
        return res.json({
            success: true,
            message: "OTP is sent to your registered mail check your email"
        });
